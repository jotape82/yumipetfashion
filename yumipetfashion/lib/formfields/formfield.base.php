...
abstract class ISC_FORMFIELD_BASE
{
	...
	public function setAttributePrivateId($labelID){
		$this->attributePrivateId = $labelID;
	}
	
	public function getAttributePrivateId(){
		return $this->attributePrivateId;
	}
