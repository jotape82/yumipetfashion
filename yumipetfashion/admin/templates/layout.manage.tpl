...
<script type="text/javascript" src="script/layout.headerimage.js?{{ JSCacheToken }}"></script>
	...
	<table class="OuterPanel">
		...
		<ul id="tabnav">
				<li><a href="javascript:ShowTab(0)" class="active" id="tab0">{% lang 'TemplateSettings' %}</a></li>
				<li><a href="javascript:ShowTab(1)" id="tab1">{% lang 'LogoSettings' %}</a></li>
				<li><a href="javascript:ShowTab(2)" id="tab2">{% lang 'DesignMode' %}</a></li>
				<li><a href="javascript:ShowTab(6)" id="tab6">{% lang 'MobileTemplate' %}</a></li>
				<li><a href="javascript:ShowTab(3)" id="tab3">{% lang 'EmailTemplates' %}</a></li>
				<li><a href="javascript:ShowTab(4)" id="tab4">{% lang 'FaviconImage' %}</a></li>
				<li><a href="javascript:ShowTab(5)" id="tab5">{% lang 'HeaderImage' %}</a></li>
		</ul>
