...
<link rel="stylesheet" type="text/css" href="Styles/orders.css" media="all" />
	...
	<script language="javascript" type="text/javascript">//<![CDATA[
		...
		lang.ChooseOneMoreItemsToShip = "{% lang 'ChooseOneMoreItemsToShip' %}";
		lang.ProblemCreatingShipment = "{% lang 'ProblemCreatingShipment' %}";
		lang.SavingNotes = "{% lang 'SavingNotes' %}";
		lang.ConfirmDelayCapture = "{% lang 'ConfirmDelayCapture' %}";
		lang.ConfirmRefund = "{% lang 'ConfirmRefund' %}";
		lang.ConfirmVoid = "{% lang 'ConfirmVoid' %}";
		lang.SelectRefundType = "{% lang 'SelectRefundType' %}";
		lang.EnterRefundAmount = "{% lang 'EnterRefundAmount' %}";
		lang.InvalidRefundAmountFormat = "{% lang 'InvalidRefundAmountFormat' %}";
		lang.ConfirmSendTrackingNumber = "{% lang 'ConfirmSendTrackingNumber' %}";
		lang.TrackingLinkEmailed = "{% lang 'TrackingLinkEmailed' %}";
		lang.ShipOrderMultipleAddressInstructions = "{% lang 'ShipOrderMultipleAddressInstructions' %}";
