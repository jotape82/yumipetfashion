 ...
 */
$GLOBALS['ISC_CFG']['ControlPanelTitle'] = "EdazCommerce 3.1 - Painel do Cliente";//(%%EDITION%% Edition);
 ...
 */
$GLOBALS['ISC_LANG']['BadLKHInv'] = "Your license key is invalid.";
$GLOBALS['ISC_LANG']['BadLKHExp'] = "Your license key expired on the %s.";

/**
 * The messages below are shown when a user or product limit is reached based on the entered license key within the store.
 */
$GLOBALS['ISC_LANG']['ReachedUserLimitMsg'] = "You cannot add any more users to your store because you have reached your limit of %s users.";
$GLOBALS['ISC_LANG']['ReachedProductLimitMsg'] = "You cannot add any more products to your store because you have reached your limit of %s products.";
