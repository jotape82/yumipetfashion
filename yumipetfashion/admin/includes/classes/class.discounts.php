		...
		private function CreateDiscountStep1()
		{
			...
			foreach ($rulesSorted as $type => $ruleType) {
				...
				*/
				...
				switch($type){
					case "Order":
						$GLOBALS['RuleList'] .= '<h4 style="margin-top:5px; margin-bottom:5px;">'.GetLang('BasedRule').'</h4>';
						break;
						
					case "Product":
						$GLOBALS['RuleList'] .= '<h4 style="margin-top:15px; margin-bottom:5px;">'.GetLang('BasedRule2').'</h4>';
						break;	
				}
