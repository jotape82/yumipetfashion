...
/**
 * Shopping Cart Ebay Integration.
 */
class ISC_ADMIN_EBAY extends ISC_ADMIN_BASE {
	...
	*/
	...
	public function HandleToDo($do)
	{
		...
		if (!count($this->getSupportedSites())) {
			...
			exit;
		} else if (!$this->checkEbayConfig() && isc_strtolower($do) != 'saveebay') {
	...
	/**
	 * To save the eBay settings on Shopping Cart
	 */
	...
	*/
	 ...
	 */
	public function checkEbayConfig($configName = '', $includeValidCheck = true)
	{
