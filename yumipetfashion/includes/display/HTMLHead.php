...
CLASS ISC_HTMLHEAD_PANEL extends PANEL
{
	public function SetPanelSettings()
	{
		...
		$GLOBALS['Stylesheets'] .= '<link href="' . GetConfig('ShopPath') . '/templates/__master/Styles/styles.css" type="text/css" rel="stylesheet" />';
		$GLOBALS['Stylesheets'] .= '<link href="' . GetConfig('ShopPath') . '/templates/__master/Styles/edazcommerce.css" type="text/css" rel="stylesheet" />';
