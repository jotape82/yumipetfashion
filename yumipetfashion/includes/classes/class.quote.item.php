...
class ISC_QUOTE_ITEM
{
	...
	*/
	...
	protected $fixedShippingCost = null;
	...
	*/
	...
	public function getThumbnail()
	{
		...
		if (!empty($productData['variation']['vcimagethumb'])) {
			return getConfig('ShopPath').'/'.getConfig('ImageDirectory').'/'.$productData['variation']['vcimagethumb'];
		}
	...
	public function setVariation($variation)
	{
		...
		$productData = $this->getProductData();
		if ($productData['prodoptionsrequired'] && $productData['prodvariationid'] && $variation == 0) {
