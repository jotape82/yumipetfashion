<?php
	...
	/**
	* This is the flat rate per item shipping module for Shopping Cart. To enable
	* flat rate per item shipping in Shopping Cart login to the control panel and click the
