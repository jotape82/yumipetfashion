...
URL DO BOLETO: <a href='".$GLOBALS['ShopPath']."/modules/checkout/boletobradesco/boleto_bradesco.php?boleto=".$id."'>".$GLOBALS['ShopPath']."/modules/checkout/boletobradesco/boleto_bradesco.php?boleto=".$id."</a><br><br><br>
