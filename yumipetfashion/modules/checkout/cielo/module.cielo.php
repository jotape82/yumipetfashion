...
function carregaParcelas(bandeira){
	...
	if(!transacaoConcluida){
		for(var i=0; i<arrayBandeiras.length; i++){
			displayBandeira = (arrayBandeiras[i] != bandeira) ? 'none' : 'block';
			$('#' + arrayBandeiras[i]).css('display',displayBandeira);
		}
...
if(in_array('V', $meios)){
$help .= "<a onclick=\"javascript:carregaParcelas('credito');\"><img src='".$GLOBALS['ShopPath']."/modules/checkout/cielo/images/credito.gif'></a>";
}

if(in_array('E', $meios)){
$help .= "<a onclick=\"javascript:carregaParcelas('debito');\"><img src='".$GLOBALS['ShopPath']."/modules/checkout/cielo/images/debito.gif'></a>";
}

if(in_array('M', $meios)){
$help .= "<a onclick=\"javascript:carregaParcelas('master');\"><img src='".$GLOBALS['ShopPath']."/modules/checkout/cielo/images/master.gif'></a>";
}

if(in_array('EL', $meios)){
$help .= "<a onclick=\"javascript:carregaParcelas('elo');\"><img src='".$GLOBALS['ShopPath']."/modules/checkout/cielo/images/elo.gif'></a>";
}

if(in_array('DIN', $meios)){
$help .= "<a onclick=\"javascript:carregaParcelas('din');\"><img src='".$GLOBALS['ShopPath']."/modules/checkout/cielo/images/dinners.gif'></a>";
}

if(in_array('DIS', $meios)){
$help .= "<a onclick=\"javascript:carregaParcelas('dis');\"><img src='".$GLOBALS['ShopPath']."/modules/checkout/cielo/images/discover.gif'></a>";
}
if(in_array('AM', $meios)){
$help .= "<a onclick=\"javascript:carregaParcelas('ame');\"><img src='".$GLOBALS['ShopPath']."/modules/checkout/cielo/images/amex.gif'></a>";
}
$help .= "</div>";
