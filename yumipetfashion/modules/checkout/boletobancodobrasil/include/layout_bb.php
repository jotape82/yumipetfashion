...
<div id="container">
	...
	<div id="instr_header">
		<h1><?php echo (isset($dadosboleto["identificacao"])) ? $dadosboleto["identificacao"] : ""; ?> <?php echo isset($dadosboleto["cpf_cnpj"]) ? $dadosboleto["cpf_cnpj"] : '' ?></h1>
		<address><?php echo (isset($dadosboleto["endereco"])) ? $dadosboleto["endereco"] : ""; ?><br></address>
		<address><?php echo (isset($dadosboleto["cidade_uf"])) ? $dadosboleto["cidade_uf"] : ""; ?></address>
	</div>	<!-- id="instr_header" -->
	...
	<div id="boleto">
		...
		<tr class="campos">
			<td class="sacado2">
				...
				<p><?php echo (isset($dadosboleto["endereco2"])) ? $dadosboleto["endereco2"] : ""; ?></p>
			</td>
		</tr>
		</tbody>
		</table>		
