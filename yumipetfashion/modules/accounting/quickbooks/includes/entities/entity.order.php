...
{
/**
 * This class is the one used to write orders into QuickBooks from the shopping cart. The one for the opposite is service.orderadd.php.
 */
	...
	public function buildQuerySyncXML()
	{
		...
		$fromModifiedDate = substr($fromModifiedDate,0,10);
